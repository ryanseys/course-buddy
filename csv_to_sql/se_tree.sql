...
-- Variables
-- SET (SELECT id FROM programs WHERE name = "Software Engineering") = (SELECT id FROM programs WHERE name = "Software Engineering");
...
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="MATH" AND code=1104), 1, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="MATH" AND code=1004), 1, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="PHYS" AND code=1003), 1, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=1005), 1, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="ECOR" AND code=1010), 1, "F");

-- Y1 TW
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="MATH" AND code=1005), 1, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="PHYS" AND code=1004), 1, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="ECOR" AND code=1101), 1, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=2006), 1, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="CHEM" AND code=1101), 1, "W");

-- Y2 TF
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="MATH" AND code=2004), 2, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="ELEC" AND code=2501), 2, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=2001), 2, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=2004), 2, "F");
...
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="COMP" AND code=3005), 3, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4001), 3, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=3110), 3, "F");

-- Y3 TW
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="STAT" AND code=3502), 3, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=3303), 3, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=3101), 3, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=3120), 3, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4106), 3, "W");

-- Y4 TF
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="ELEC" AND code=4705), 4, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4101), 4, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4120), 4, "F");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4927), 4, "F");

-- Y4 TW
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4005), 4, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4507), 4, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="ECOR" AND code=4995), 4, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4927), 4, "W");
INSERT INTO program_reqs (program, course, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), (SELECT id from COURSES WHERE dept="SYSC" AND code=4806), 4, "W");
...
INSERT INTO program_elective_groups (program, req_group, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), "SE Note A", 3, "F"); -- schedule first elective
INSERT INTO program_elective_groups (program, req_group, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), "SE Note A", 4, "F"); -- sechedule second elective
INSERT INTO program_elective_groups (program, req_group, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), "SE Note A", 4, "W"); -- schedule third elective
...
INSERT INTO program_elective_groups (program, req_group, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), "SE Note B", 4, "F"); -- schedule Note B elective
...
-- CSEs
INSERT INTO program_elective_groups (program, req_group, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), "CSE", 2, "F");
INSERT INTO program_elective_groups (program, req_group, year, term) VALUES ((SELECT id FROM programs WHERE name = "Software Engineering"), "CSE", 2, "W");
